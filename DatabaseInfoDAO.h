...
namespace DrvFtaeAlarm {
	...
	public:
		...
		virtual std::unique_ptr<SQLTable> GetTableInfo(bool isOpenConnection, bool isCloseConnection, const ConnectionAttributes& attributes, std::string databaseName, std::string tableName) = 0;
	protected:
