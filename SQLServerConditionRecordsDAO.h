...
namespace DrvFtaeAlarm {
	...
	public:
		...
		std::vector<Record> GetRecords(const SQLTable& table, const ConnectionAttributes& attributes, const std::vector<StatementCondition>& conditions, std::string txtSql) override;
	private:
